...
% Initialize colors : 
clrSett = struct();
clrSett.matColors = [[34, 245, 154]; [92, 182, 242]; [4, 80, 130]; [24, 94, 64]]./255;
clrSett.srcColors = [[232, 27, 0]; [224, 101, 0]; [143, 11, 11]; [204, 41, 136]]./255;
clrSett.drbColors = [[250, 250, 37]; [175, 186, 19]; [24, 56, 184]; [252, 252, 177]]./255;
